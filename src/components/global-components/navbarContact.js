...
import SocialContact from "../section-components/social-contact";
            ...
            <div className="row">
              ...
              <div className="col-md-5">
                <div className="top-bar-right text-end">
                  <div className="ltn__top-bar-menu my-2">
                    <SocialContact />
                  </div>
                </div>
              </div>
          ...
          <div className="container">
            <div className="row">
              <div className="d-flex justify-content-between">
                ...
                <div className="col header-menu-column d-flex justify-content-end">
