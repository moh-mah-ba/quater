...
const ShopGridV1 = () => {
  ...
  const { allProperties , error, properties, currentItemsPerPage, totalPages } = propertyList;
      ...
      <div className="ltn__product-area ltn__product-gutter">
        <div className="container">
          <div className="row">
            ...
            <Sidebar propertyType={propertyType} setPropertyType={setPropertyType} setCatagory={setCatagory} catagory={catagory} />
          </div>
        </div>
      </div>
    </div>
